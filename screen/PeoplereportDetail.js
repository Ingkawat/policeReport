...
const PeoplereportDetail = ({navigation,route}) => {
  const [modalVisible, setModalVisible] = useState(false);
   ...
   const confirmreport = () =>{
    ...
    axios
    .post("http://192.168.1.36:3000/peoplereportDetail",{
        report:report,
        id:id,
        date:datetext,
            ...
            <View style={styles.modalView}>
              ...
              <View style={styles.row}>
                <Pressable
                  ...
                  onPress={() => {confirmreport(),setModalVisible(!modalVisible)}}
                >
...
export default PeoplereportDetail;